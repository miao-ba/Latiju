...
class ManifestFilterForm(forms.Form):
    ...
    company_name = forms.CharField(
        ...
        required=False, 
        label="事業機構名稱",
        widget=forms.TextInput(attrs={'class': 'ts-input', 'placeholder': '請輸入事業機構名稱'})
    )
    ...
    waste_code = forms.CharField(
        ...
        required=False, 
        label="廢棄物代碼",
        widget=forms.TextInput(attrs={'class': 'ts-input', 'placeholder': '請輸入廢棄物代碼'})
    )
    ...
    waste_name = forms.CharField(
        ...
        required=False, 
        label="廢棄物名稱",
        widget=forms.TextInput(attrs={'class': 'ts-input', 'placeholder': '請輸入廢棄物名稱'})
    )
